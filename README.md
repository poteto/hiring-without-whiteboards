...
- [Modash](https://www.modash.io/careers) | Estonia | (Remote Europe timezone) Join a team that values transparency and creativity! Here's what to expect: an initial chat with HR, a coding task covering real-world front-end and back-end challenges (yes, you can use Google!), a system design interview based on a real problem we faced, and finally, a conversation with our CEO, Avery, to align expectations. Dive deeper into the process [here](https://www.modash.io/blog/engineering-interviews-at-modash).
