...
- [Etermax](https://etermax.com/en/careers/) | Buenos Aires, Argentina | Skype/phone screen with two engineers & HR, 2 hour onsite pair programming session (with focus on testing and design) with feedback
