...
- [optilyz](https://optilyz.com/careers) | Remote from Germany or Poland | Either take-home or pair programming on open-source code, then pair programming on our actual production code.
