...
- [Nurx](https://www.nurx.com/careers#roles) | San Francisco, CA; Remote | Phone screen with recruiter and/or hiring manager, tech screen with option for a take-home assignment or a live coding session (both of which are relevant to the domain), and then virtual on-site with a solution debrief, peer review of a technical document, architecture design, and incident debugging. A lot of opportunities to taste a collaborative environment.
