...
- [Intuit](https://www.intuit.com/careers/) | Mountain View, CA | Craft round - 90 minutes of live programming on a real-world problem, which can include API/UI/DB creation -> Demo with the hiring team -> Questions on the solution design, architecture, and tradeoffs.
