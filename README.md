...
- [Minnesota Twins](https://www.mlb.com/twins) | Minneapolis, MN | You are given the opportunity to choose the technical interview format (ahead of time). These options include realistic coding challenges reflecting the job or bringing your own project to colaborate. No take-home assignments - just real-time coding and collaboration with the developers which made the interview process more fun and engaging.
