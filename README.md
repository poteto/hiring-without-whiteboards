...
- [Alluvium](https://alluvium.io/careers/) | Brooklyn, NY | Take-home assignment, on-site review dovetailing into collaborative project planning for extension.
...
- [Arachnys](https://angel.co/arachnys/) | London, UK | Take home test, real world pair programming
...
- [ASOS](https://asoscareers.asos.com) | London, UK | Take home or in-person code refactoring exercise, in-person walk-though of solution including software crafstmanship principles and design decisions, in-person freestyle architecture walk-through
...
- [Avant](https://www.avantcredit.co.uk) | Chicago, IL | Pair programming interviews.
...
- [Bits of Love](http://www.bitsoflove.be/en/careers) | Bruges, Belgium | In-person interview to evaluate experience and motivation, potentially followed by take-home project.
...
- [Bulb](https://bulb.co.uk/careers/) | London, UK | Phone screening, followed by a 2-4 hours take home task. If successful, on-site interview to discuss and extend with the reviewer and one other engineer, followed by 2x informal "Meet the team" interviews.
...
- [Caravelo](https://caravelo.bamboohr.com/jobs/) | Barcelona, Spain | Take home project, then technical discussion about the code in-person or Skype and hang out with the team.
...
- [Centroida](https://www.centroida.ai/#/careers) | Sofia, Bulgaria | Series of interviews, pair programming and take-home projects
- [Chain.Reaction](https://www.linkedin.com/company/chain.reaction/jobs/) | Budapest, Hungary | Partnership-fit discussion, code-review and trial days.
...
- [City of Philadelphia's Office of Open Data & Digital Transformation](https://www.phila.gov/departments/office-of-open-data-and-digital-transformation/) | Philadelphia, PA | Take-home project
...
- [CJ Affiliate](https://jobs.cj.com/jobs/category/engineering/#/) | Los Angeles, CA & Westlake Village, CA | Phone coding design exercise (no algorithms), followed by an on-site final interview that includes pair programming on a realistic object-oriented design problem
...
- [Clockwork Consulting](https://cwconsult.dk) | Copenhagen, Denmark | Interviews, discussion of technical background and experiences.
- [Cloudistics](https://www.cloudistics.com/company/career/) | Reston, VA | Multiple interviews, discussion of technical background and experiences.
...
- [Cognitect, Inc.](https://cognitect.com/about.html#careers) | Remote | Phone interview followed by pair programming.
- [Cognitran](https://www.cognitran.com/employment-opportunities/) | Essex, UK / Szczecin, Poland / Detroit, MI | Skype/phone interview followed by pair programming.
...
- [ContentSquare](https://contentsquare.com/about/careers/) | Paris, France | Real-world challenges with open discussions.
...
- [Credit Kudos](https://www.creditkudos.com/careers) | London, UK | Take-home project and pair programming via Skype or on-site.
...
- [Datlinq](https://datlinq.com/en/) | Rotterdam, Netherlands | Take-home project based on actual work on data done by the team and in-person or Skype interviews
...
- [Dentolo](https://angel.co/dentolo/jobs) | Berlin, Germany | Phone interview with the HR department, take-home project and technical interview to discuss your skill set + general questions
...
- [DoorDash :runner::dash:](https://www.doordash.com/careers/) | San Francisco, CA | Take home project + an on-site interview building off the project!
...
- [eMarketer](https://www.emarketer.com/careers.aspx) | New York, NY | Short phone interview, then come in and meet the team, check out our space, and have a discussion with team members about real-world problems
...
- [Fauna](https://fauna.com/careers) | San Francisco, CA / Remote | Take home project, then follow up with interviews on-site or remote. Interviews are both technical and non-technical. Technical interviews comprehend the scope of the home project.
...
- [Funda](https://content.funda.nl/en/working-at/funda/) | Amsterdam, The Netherlands | Take Home test + Discussion On-Site/Remote
...
- [GTM Sportswear](http://careers.gtmsportswear.com) | Manhattan, KS / Remote | Remote pairing session, then a take-home test.
...
- [Healthify](https://healthify.workable.com) | Remote & New York City, NY | Take-home project, discussion via Zoom, pair programming with us on our app for a day.
...
- [Human API](https://www.humanapi.co/careers) | Redwood City, CA | Technical phone interview, then on-site pair programming and design discussion
- [I|O](https://io.co.za/opportunities) | Cape Town, South Africa
- [Icalia Labs](https://www.icalialabs.com/culture#positions) | Monterrey, Mexico | Pair programming, cultural fit session
...
- [inKind Capital](https://www.inkind.com/jobs) | Boulder, CO | Discussing real-world problems, pair programming, dinner & drinks with the team
...
- [Koddi Inc.](https://koddi.com/careers/) | Fort Worth, TX | Phone Interview(s), take-home project, on-site interview
...
- [Korbit](https://www.korbit.co.kr) | Seoul, South Korea | Take home assignment followed by on-site code review and interview
...
- [LoanZen](http://loanzen.in) | Bengaluru, India | Initial phone interview about experience, a solve-at-home project based on the kind of work we do at our company, on-site interview discussing the submitted solution and a general discussion with the whole team
...
- [Locastic](https://locastic.com/careers/) | Split, Croatia | Take-home code challenge, tehnical discussion & on-site programming session, meet & greet with the team
...
- [Logic Soft](https://www.logicsoft.co.in/careers.php) | Chennai, India | Phone discussion, F2F pair programming exercise + discussion
...
- [Loom](https://www.loom.com/careers) | San Francisco, CA | Google Hangouts resume dive on past experience, take-home project OR architectural phone screen, on-site interviews (2 technical architecture related to work, 1 or 2 non-technical)
...
- [Lyoness Austria GmbH](https://www.lyoness-corporate.com/en/) | Graz, Austria | Take-Home project, discussion on-site
...
- [Mango Solutions](https://www.mango-solutions.com/about/careers) | London (UK), Chippenham (UK) | Initial phone interview, followed by on-site interview with take-home assignment
...
- [Mimir](https://www.mimirhq.com/careers) | Indianapolis, Indiana | Take home interview, phone screen, in person interview where you decide how you want to be interviewed (questions, pair programming, etc.)
...
- [Nexcess.net](https://www.nexcess.net/about/careers/) | Southfield, MI | We mostly chat to get a feel on both ends if there's a good cultural fit. We ask questions to see what experience you have and how you think as a programmer. At some point we look at some of your code or have you work on some of ours (1 hour).
...
- [Noa](http://www.noa.one) | Berlin, Germany; San Francisco, CA | 1 technical chat, 2-3 cultural chats with colleagues from different departments in the team, if these work a pair programming exercise
- [NodeSource](http://nodesource.com/careers) | Remote | A person-to–person walk through of a past project of yours
- [Nomoko,camera](https://boards.greenhouse.io/nomoko) | Zurich, Switzerland | Three interrogations
...
- [Nozbe](https://nozbe.com/index.html) | Remote | Take-home exercise & interview with the team
...
- [O'Reilly Media](https://www.oreilly.com/careers/) | Sebastopol, CA; Boston, MA; Remote | Phone conversation, take-home exercise or pair programming session, team interview, all via Google Hangout
...
- [Outbrain](https://www.outbrain.com/about/careers/) | NYC, Israel | Take-home exercise & discussion
...
- [Platform45](https://www.platform45.com) | Johannesburg, South Africa; Cape Town, South Africa | On-site interview, take-home project and culture fit day
- [Playlyfe](https://getcatalyst.in) | Bangalore, India | Short personal interview, on-site demonstration of programming in browser devtools followed by discussion about the problem
...
- [Pusher](https://pusher.com/careers) | London, UK | Solve a real-world problem through a design session with our engineers
- [Pygmalios](https://pygmalios.com/careers/) | Bratislava, Slovakia | Take-home project related to business and discussion with our engineers.
- [Quiet Light Communications](https://www.quietlightcom.com/join-our-team/) | Rockford, IL, USA | Discussion, work samples and/or small freelance project
- [Quintype](https://www.quintype.com/careers) | Bengaluru, India / San Mateo, USA | Take home project, pair programming, discussion on-site
...
- [Rapyuta Robotics](http://www.rapyuta-robotics.com/careers) | Bengaluru, India / Tokyo, Japan / Zurich, Switzerland | Take-home assignment related to our ongoing projects, series of technical / experience based interviews, candidate presentation
...
- [RedCarpet](https://www.redcarpetup.com/careers/) | New Delhi, India | Interview, work sample/take-home project and discussion/code reviews
...
- [Relabe](https://www.linkedin.com/company/relabe/about/) | San Juan, PR | First we screen for cultural fit then check for technical proficiency. 2-3 Interviews max in SJ
...
- [Samsara](https://www.samsara.com/uk/jobs) | San Francisco, CA; Atlanta, GA; London, UK | Phone interview, onsite interview (technical challenges based on real problems we've faced at Samsara)
...
- [Séntisis](https://sentisis.com/trabaja-con-nosotros/) | Madrid, Spain; Mexico City, Mexico; Bogotá, Colombia; Santiago de Chile, Chile; Remote | Phone call, on-site/remote interview including discussion about projects/skills and a short real-world pair-programming exercise
...
- [Slack](https://slack.com/careers) | San Francisco, CA | Call with recruiter, 1 week take-home project, call with hiring manager, on-site interview covering high-level system design, best software development practices and culture-fit
...
- [Subvertical (VerticalChange)](https://verticalchange.com) | Remote | Phone screening, live pair programming & personal project code review
...
- [Superplayer](https://www.superplayer.fm/player) | Porto Alegre, Brazil | Skype/On-site interview, take-home project and interview with CTO and CEO
...
- [SweetIQ](https://sweetiq.com/about/careers-2/) | Montreal, Canada | Discussion and general, high level questions
...
- [Ubots](https://ubots.com.br/oportunidades/#vagas) | Porto Alegre, Brazil | Skype/On-site interview, take-home project, technical interview
...
- [Verve](http://verve.co/careers/) | London, UK | An intentionally short, take home exercise that mirrors real project work and incorporates code review elements
...
- [VSX](https://www.vsx.net/en/job-offers/) | Dresden, Germany | On-site interview, home coding challenge, presentation/discussion of proposed solutions
...
- [500friends](http://500friends.com/careers) | San Francisco, CA; Remote | Take home challenge followed by onsite expansion of the submission and high level discussions (design exercise or overview of past projects)
