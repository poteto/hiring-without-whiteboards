...
- [Demand Driven Technologies](https://demanddriventech.com/our-careers) | Remote / Redmond, WA / Atlanta, GA / Bordeaux, France | Introductory discussion. Technical video interview loop with engineers (no deep algorithmic whiteboarding, no "brainteasers"), additional exporatory session(s) designing real solutions to business problem(s), followed by culture/fit with hiring manager. Take home assignments in a few select situations.
